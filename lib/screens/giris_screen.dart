          ...
          child: Form(
            ...
            child: Column(
              children: [
                ...
                if (_kayitModu) ...[
                  const SizedBox(height: 14),
                  _Alan(ctrl: _adresCtrl, label: 'Adres', icon: Icons.location_on_outlined, maxLines: 2,
  ...
  Future<void> _gonder() async {
    ...
    try {
      ...
      if (sonuc['success'] == true) {
        ...
        await SiparisBildirimServisi.instance.kullaniciGirisYapti(_telCtrl.text.trim());
